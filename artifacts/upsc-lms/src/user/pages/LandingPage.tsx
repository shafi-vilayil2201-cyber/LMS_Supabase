  ...
  return (
    <div className="min-h-screen" style={{ background: "#F8F9FA", fontFamily: "Nunito, sans-serif" }}>
        ...
        <div className="max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-16 items-center relative z-10">
          <motion.div initial="hidden" animate="visible" variants={fadeUp} transition={{ duration: 0.6 }}>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold mb-6 border border-white/20"
              style={{ background: "rgba(255,107,0,0.15)", color: SAFFRON }}>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={s.l} className="text-center">
              <p className="text-3xl font-bold" style={{ color: NAVY, fontFamily: "Inter, sans-serif" }}>{s.n}</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div className="text-center mb-12" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h2 className="text-3xl font-bold mb-3" style={{ color: NAVY, fontFamily: "Inter, sans-serif" }}>Choose Your Exam Vertical</h2>
      ...
      <section className="py-20" style={{ background: `${NAVY}06` }}>
        <div className="max-w-7xl mx-auto px-6">
          <motion.div className="text-center mb-14" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h2 className="text-3xl font-bold mb-3" style={{ color: NAVY, fontFamily: "Inter, sans-serif" }}>How IGen Works</h2>
            ...
            {steps.map((s, i) => {
              ...
              return (
                <motion.div key={s.title} initial="hidden" whileInView="visible" viewport={{ once: true }}
                  ...
                  <div className="text-center bg-white rounded-2xl p-8 border border-border shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <h3 className="text-lg font-bold mb-2" style={{ color: NAVY, fontFamily: "Inter, sans-serif" }}>{s.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
              <h2 className="text-3xl font-bold mb-4" style={{ color: NAVY, fontFamily: "Inter, sans-serif" }}>Stay Motivated with Gamification</h2>
                ...
                {[
                  ...
                  return (
                    <div key={f.label} className="flex items-start gap-4 p-4 rounded-xl border border-border">
                      ...
                      <div>
                        <p className="font-semibold text-sm" style={{ color: NAVY }}>{f.label}</p>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              <div className="rounded-2xl p-6 border border-border shadow-sm bg-white">
                <p className="font-semibold text-sm mb-5" style={{ color: NAVY }}>Weekly Progress — Week 12 of 52</p>
                ...
                <div className="p-3 rounded-xl flex items-center gap-3"
                  ...
                  <div>
                    <p className="text-xs font-semibold" style={{ color: NAVY }}>Week 13 Locked</p>
      ...
      <section className="py-20" style={{ background: `${NAVY}06` }}>
        <div className="max-w-7xl mx-auto px-6">
          <motion.div className="text-center mb-12" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h2 className="text-3xl font-bold mb-3" style={{ color: NAVY, fontFamily: "Inter, sans-serif" }}>Learn from the Best</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {mentors.map((m, i) => (
              <motion.div key={m.name} initial="hidden" whileInView="visible" viewport={{ once: true }}
                ...
                <div className="bg-white rounded-2xl p-5 border border-border hover:shadow-md transition-shadow text-center">
                  <div className="w-14 h-14 rounded-full mx-auto mb-3 flex items-center justify-center text-xl font-bold text-white"
                    style={{ background: NAVY }}>{m.name.charAt(0)}</div>
                  <h3 className="font-semibold text-sm mb-1" style={{ color: NAVY }}>{m.name}</h3>
                  {m.badge && (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <motion.div className="text-center mb-12" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h2 className="text-3xl font-bold mb-3" style={{ color: NAVY, fontFamily: "Inter, sans-serif" }}>Simple, Transparent Pricing</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={plan.name} className={`rounded-2xl p-7 border ${plan.highlight ? "shadow-xl" : "border-border"}`}
                style={plan.highlight ? { borderColor: SAFFRON, background: `${NAVY}03` } : {}}>
                {plan.highlight && <div className="text-xs font-bold mb-3 uppercase tracking-wider" style={{ color: SAFFRON }}>Most Popular</div>}
                <h3 className="text-xl font-bold mb-1" style={{ color: NAVY, fontFamily: "Inter, sans-serif" }}>{plan.name}</h3>
                <p className="text-sm text-muted-foreground mb-4">{plan.desc}</p>
                <div className="flex items-end gap-2 mb-6">
                  <span className="text-4xl font-bold" style={{ color: NAVY, fontFamily: "Inter, sans-serif" }}>{plan.price}</span>
                ...
                <button onClick={() => setLocation("/register")}
                  ...
                  style={plan.highlight ? { background: SAFFRON, color: "white" } : { background: NAVY, color: "white" }}>
                  {plan.cta}
                </button>
              </div>
            ))}
      ...
      <section className="py-20" style={{ background: `${NAVY}06` }}>
        <div className="max-w-3xl mx-auto px-6">
          <motion.div className="text-center mb-12" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h2 className="text-3xl font-bold" style={{ color: NAVY, fontFamily: "Inter, sans-serif" }}>Frequently Asked Questions</h2>
          </motion.div>
            ...
            {faqs.map((faq, i) => (
              <div key={i} className="bg-white rounded-xl border border-border overflow-hidden">
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)}
                  ...
                  <span className="font-medium text-sm pr-4" style={{ color: NAVY }}>{faq.q}</span>
