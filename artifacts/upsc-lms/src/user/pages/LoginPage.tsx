    ...
    <div className="min-h-screen flex" style={{ background: "#0A1628" }}>
      <div className="flex-1 hidden lg:flex flex-col justify-center px-16">
        <div className="max-w-md">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-6" style={{ background: "#FF6B00" }}>
          ...
          <div className="mt-10 grid grid-cols-3 gap-4">
            {[
              ...
              <div key={s.l} className="rounded-xl p-4" style={{ background: "rgba(255,255,255,0.05)" }}>
                <p className="text-2xl font-bold" style={{ color: "#F5A623" }}>{s.n}</p>
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <div className="mt-6 rounded-xl p-4 border border-border" style={{ background: "#F8F9FA" }}>
              ...
              <div className="space-y-2">
                {demos.map((d) => (
                  ...
                  >
                    <span className="inline-block w-16 text-xs font-semibold" style={{ color: "#FF6B00" }}>{d.role}</span>
            ...
            <p className="text-center text-sm text-muted-foreground mt-6">
              ...
              <button onClick={() => setLocation("/register")} className="font-semibold hover:underline" style={{ color: "#FF6B00" }}>
                Register
              </button>
            </p>
          </div>
